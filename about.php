      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="mu-features-area">
            ...
            <div class="mu-title">
              <h2>Our Features</h2>
              <p>Find the right course with Courser. Search and compare reviews to find the right course for you</p>
            </div>
            <!-- End Title -->
              ...
              <div class="row">
                <div class="col-lg-4 col-md-4  col-sm-6">
                  <div class="mu-single-feature">
                    ...
                    <p>We offer courses such as A levels, foundation, diploma, degrees and more.</p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="mu-single-feature">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="mu-single-feature">
                    ...
                    <p>Study online at your own pace, in the comfort of your own home</p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="mu-single-feature">
                    ...
                    <p>Students that enroll through Courser are guaranteed a professional certificate at the end of their completed study.</p>
                  </div>
                </div>
              </div>
            </div>
